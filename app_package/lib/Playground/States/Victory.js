...
class Victory extends State_1.State {
    constructor() {
        super(...arguments);
        this.ship = null;
    }
    ...
    enter() {
        ...
        if (GuiFramework_1.GuiFramework.isLandscape) {
            ...
            GuiFramework_1.GuiFramework.createPageTitle("Victory", panelGrid);
            grid.addControl(stats, 0, 1);
            const splashText = GuiFramework_1.GuiFramework.createSplashText("All your base are belong to us!");
            ...
            GuiFramework_1.GuiFramework.addButton("Next Battle", panel).onPointerDownObservable.add(function (info) {
                var _a;
            ...
            let textBlock = new gui_1.TextBlock("", "VICTORY");
